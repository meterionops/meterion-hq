...
-- Resume Anywhere v1.1
-- Distinguish an active project with autonomy_state=inactive from a project that
-- is actually paused/completed/archived. Maintenance projects may be active in
-- the portfolio while intentionally idle between explicit work requests.
...
comment on function public.control_room_get_resume_packet_v1(text) is
  'Compact Resume Anywhere packet v1.1: current project state, freshness/source pointers, work mode and up to five recent material events.';
