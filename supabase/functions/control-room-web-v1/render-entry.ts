...
function enhanceReiskaAssistantHtml(html: string): string {
  let out = html;
  out = out.replace('<meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/>', '<meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"/><meta name="theme-color" content="#f4f5f2"/><meta name="apple-mobile-web-app-capable" content="yes"/><meta name="apple-mobile-web-app-status-bar-style" content="default"/>');
  out = out.replace('<title>Meterion Control Room</title>', '<title>Reiska · Meterion</title>');
