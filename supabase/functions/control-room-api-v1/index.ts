    ...
    try {
      switch (action as Action) {
        case "get_project_state": {
          ...
          result = await admin.rpc("control_room_get_project_state_v1", {
        ...
        case "list_projects": {
          ...
          const lifecycleStatus = optionalString(body.lifecycle_status);
          if (
            (body.portfolio_class !== undefined && portfolioClass === null) ||
            (body.lifecycle_status !== undefined && lifecycleStatus === null)
          ) {
            return json(400, {
              ok: false,
              code: "invalid_filter",
          ...
          result = await admin.rpc("control_room_list_projects_v1", {
